  ...
  return (
    ...
    >
      <div
        ...
        className={`relative mx-4 w-full max-w-lg rounded-lg border border-border bg-background p-6 text-foreground shadow-xl transition-all dark:bg-secondary dark:text-secondary-foreground ${
